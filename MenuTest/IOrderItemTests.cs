...
namespace MenuTest
{
    public class IOrderItemTests
    {
        ...
        [InlineData(Size.Medium)]
        [InlineData(Size.Large)]
        public void MezzorellaStickDescriptionShouldGiveNameForSize(Size size)
        {
        ...
        [InlineData(Size.Medium)]
        [InlineData(Size.Large)]
        public void TriceritotsDescriptoinShouldGiveNameForSize(Size size)
        {
